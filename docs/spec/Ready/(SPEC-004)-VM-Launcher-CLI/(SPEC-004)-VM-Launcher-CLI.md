...
- [ADR-002](../../../adr/Accepted/(ADR-002)-Taint-and-Verify-Data-Flow-Model.md) — Taint-and-verify model defining L1/L2 scanning the launcher coordinates
- [ADR-005](../../../adr/Accepted/(ADR-005)-Composable-VM-Isolation.md) — Architectural decision making VM isolation composable with Docker
...
- [SPIKE-015](../../../research/Complete/(SPIKE-015)-Evaluate-VM-Isolation-for-Agent-Container/(SPIKE-015)-Evaluate-VM-Isolation-for-Agent-Container.md) — VM technology evaluation that selected libkrun
- [SPIKE-017](../../../research/Complete/(SPIKE-017)-Validate-libkrun-virtio-net-macOS/(SPIKE-017)-Validate-libkrun-virtio-net-macOS.md) — Validated gvproxy + virtio-net networking on macOS
- [SPIKE-022](../../../research/Complete/(SPIKE-022)-VM-Infrastructure-Egress-Enforcement/(SPIKE-022)-VM-Infrastructure-Egress-Enforcement.md) — Established gvproxy allowlist as primary egress enforcement
