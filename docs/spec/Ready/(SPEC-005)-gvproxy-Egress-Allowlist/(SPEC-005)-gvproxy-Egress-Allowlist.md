...
- [ADR-010](../../../adr/Adopted/(ADR-010)-Platform-Specific-VM-Orchestration.md) — Platform-specific orchestration reaffirming gvproxy as the networking layer
- [EPIC-002](../../../epic/Active/(EPIC-002)-VM-Isolated-Agent-Runtime/(EPIC-002)-VM-Isolated-Agent-Runtime.md) — Parent epic delivering the agent enforcement boundary
- [JOURNEY-001](../../../journey/Validated/(JOURNEY-001)-Securing-an-AI-Assistant/(JOURNEY-001)-Securing-an-AI-Assistant.md) — User journey requiring egress control (PP-01)
- [SPIKE-017](../../../research/Complete/(SPIKE-017)-Validate-libkrun-virtio-net-macOS/(SPIKE-017)-Validate-libkrun-virtio-net-macOS.md) — Validated gvproxy networking on macOS
- [SPIKE-020](../../../research/Complete/(SPIKE-020)-TSI-Scope-Egress-Sufficiency/(SPIKE-020)-TSI-Scope-Egress-Sufficiency.md) — Ruled out TSI scope as sole enforcement, confirming gvproxy approach
