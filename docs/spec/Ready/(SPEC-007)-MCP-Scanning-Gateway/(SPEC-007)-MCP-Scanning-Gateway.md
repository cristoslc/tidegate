...
- [ADR-004](../../../adr/Accepted/(ADR-004)-IPC-Orchestrator-Scanning-as-Enforcement-Seam.md) — IPC scanning as enforcement seam; same scanning pipeline reused
- [JOURNEY-001](../../../journey/Validated/(JOURNEY-001)-Securing-an-AI-Assistant/(JOURNEY-001)-Securing-an-AI-Assistant.md) — User journey requiring MCP tool-call scanning (PP-01)
