...
- [ADR-002](../../../adr/Accepted/(ADR-002)-Taint-and-Verify-Data-Flow-Model.md) — Requires eBPF-capable kernel for taint tracking in the guest
- [ADR-005](../../../adr/Accepted/(ADR-005)-Composable-VM-Isolation.md) — Architectural decision requiring a VM guest image
- [ADR-010](../../../adr/Adopted/(ADR-010)-Platform-Specific-VM-Orchestration.md) — Specifies OCI guest images via Dockerfile for libkrun
