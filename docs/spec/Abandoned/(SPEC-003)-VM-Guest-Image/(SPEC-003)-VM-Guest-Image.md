...
1. **Test**: Write a boot-time benchmark script that measures kernel boot → shell ready.
2. **Implement**: Create Alpine-based Dockerfile with Node.js, Python, git. Write `init.sh`.
3. **Test**: Boot in libkrun, verify all runtimes available.
...
| Abandoned | 2026-03-13 | e6a1bcb | Superseded by SPEC-006 under EPIC-002; same requirements, new parent |
