...
| ADR-010 | [Platform-Specific VM Orchestration](./Adopted/(ADR-010)-Platform-Specific-VM-Orchestration.md) | Adopted | 2026-03-13 | 8cacbfa |
...
| ADR-008 | [libkrun as Single VMM for Agent Isolation](./Superseded/(ADR-008)-libkrun-Single-VMM-for-Agent-Isolation.md) | Superseded | 2026-03-13 | 8cacbfa | ADR-009 (egress) + ADR-010 (orchestration) |
