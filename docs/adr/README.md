...
ADRs record architectural decisions with alternatives considered and rationale. They are cross-cutting — linked to affected artifacts but not owned by any single one.

## Index

See [list-adrs.md](list-adrs.md) for lifecycle tracking.
